...
class Base{
  ...
  initPlayList(){
    ...
    .set('r8',{
      bonus: 9,
      tip: '从01~11中任选8个或多个号码，所选号码与开奖号码任意八个号码相同，即中奖<em class="red">6</em>元',
      name: '任八'
    })
  }
  ...
  setOmit(omit){
    ...
    $(self,omit_el).each(function(index,item){
      $(item).text(self.omit.get(index))  //map
    });
  }
  ...
  changePlayNav(e){
    let self = this;
    let $cur = $(e.currentTarget);
    $cur.addClass('active').sibings().removeClass('active');
